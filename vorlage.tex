...
\usepackage[toc,acronyms,style=altlist]{glossaries}        

\makeglossaries
%% Sharelatex: Wenn vorlage nicht im Root liegt, anstatt \makenoidxglossaries benutzen
...
\input{chapter/glossary_collection}
